...
<head>
    <style>
        ...
        .divlogo {
            ...
            text-align: center;
            border-bottom: 40px solid #D74819;
        }
...
<body>
    ...
    <div class="row">
        <div class="col-md-6 divlogo">
            <div>
                <img src="{{ asset('assets/admin/img/logo2.svg') }}" alt="">
                <br> <br> <br>
            ...
            <div class="form">
                <form action="" method="post">
                    <div class="form">
                        ...
                        <div class="form-group">
                            <input type="password" name="name" class="form-control" placeholder="Confirmar senha*">
                            <div class="info">
                                <p>Siga as regras para senha segura</p>
                                <p>
                                    - Mínimo 8 caracteres <br>
                                    - Letras maiúsculas e minúsculas <br>
                                    - Letras e números <br>
                                    - Pelo menos um caracter especial <br>
                                </p>
                                <p>
                                    Ofertas personalizadas <br><br>
                                    Desejo receber ofertas personalizadas e
                                    novidades do (Nome da empresa)
                                </p>
                            </div>
                        ...
                        <div class="form-group">
                            <a href="" class="btn btn-primary">Continuar <i
